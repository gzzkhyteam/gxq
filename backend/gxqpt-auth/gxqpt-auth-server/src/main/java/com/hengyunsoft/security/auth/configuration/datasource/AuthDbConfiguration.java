...
@EnableCaching
@MapperScan(
        basePackages = {"com.hengyunsoft.platform.admin", "com.hengyunsoft.platform.developer"},
...
public class AuthDbConfiguration {
    ...
    public SqlSessionFactory rdsSqlSessionFactory(@Qualifier("dataSource_admin") DataSource rdsDataSource) throws Exception {
        return DataSourceFactory.
                createSqlSessionFactoryBean(rdsDataSource, new String[]{"classpath:mapper_admin/**/*.xml", "classpath:mapper_developer/**/*.xml"})
                .getObject();
    }
