...
public class JWTHelper {
     ...
     * @throws Exception
     */
    public static Token generateToken(IJWTInfo jwtInfo, String priKeyPath, int expire) throws BizException {
        try {
            String compactJws =
                    //返回的字符串便是我们的jwt串了
                    Jwts.builder()
                            //设置主题
                            .setSubject(String.valueOf(jwtInfo.getAppId()))
                            .claim(CommonConstants.JWT_KEY_NAME, jwtInfo.getAppName())
