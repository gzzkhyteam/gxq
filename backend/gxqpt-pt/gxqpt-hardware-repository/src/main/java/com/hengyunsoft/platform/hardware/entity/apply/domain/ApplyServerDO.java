...
public class ApplyServerDO extends BaseEntity<Long> implements Serializable {
    /**
     * 磁盘
     */
    ...
    public String getNetScopeName() {
        return netScopeName;
    }

    public void setNetScopeName(String netScopeName) {
        this.netScopeName = netScopeName;
    }
}