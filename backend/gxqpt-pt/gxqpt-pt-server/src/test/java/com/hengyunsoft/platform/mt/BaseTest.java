package com.hengyunsoft.platform.mt;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.hengyunsoft.platform.GxqptPtApplication;
...
@SpringBootTest(classes = GxqptPtApplication.class)
@AutoConfigureMockMvc
public class BaseTest {

    @Autowired
    protected MockMvc mvc;
    protected String token = "eyJhbGciOiJSUzI1NiJ9.eyJzdWIiOiI0NWtqNjM1MiIsImFwcE5hbWUiOiLkupHnm5jnrqHnkIbns7vnu58iLCJleHAiOjE1MjgzNTA4NDF9.RuUf-YqUPhhnYOVzwqk9SOE6JJgRddTBAPwyzLAu5dFl8JBeS7mPaOsfhUtiEQksDVEpBeSLx22Bv1i2UEEjAz6adfeWn7yaOvcFQ6Y0bsDAWJEB59UnPKIUVwZR7mWoaXSt7sv1_NKJpm4qS-C8GlFM0XNsoO0AygppEfGATWM";
    @Autowired
    ...
    public void setBefore() {
        ...
        token = hashOperations.get("dev:gxqpt-auth-server:app:token:45kj6352", "45kj6352");
