...
@Repository
public interface ServiceManageMapper extends com.hengyunsoft.base.dao.BaseNormalDao<Long, ServiceManage, com.hengyunsoft.platform.ops.repository.service.example.ServiceManageExample> {
    /**
     * 查询服务管理分页信息
     * @param map
     * @return
