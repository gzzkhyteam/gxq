...
@Repository
public interface FaultManageMapper extends com.hengyunsoft.base.dao.BaseNormalDao<Long, com.hengyunsoft.platform.ops.entity.fault.po.FaultManage, com.hengyunsoft.platform.ops.repository.fault.example.FaultManageExample> {
    /**
     * 查询故障分页信息
     * @param map
     * @return
     ...
     * @return
     */
    public Integer getApplicationRatioSum(Map<String,Object> param);
}