package com.hengyunsoft.platform.config.dozer;
...
@EnableConfigurationProperties(com.hengyunsoft.platform.config.dozer.DozerConfigurationProperties.class)
public class DozerAutoConfiguration {

    private final com.hengyunsoft.platform.config.dozer.DozerConfigurationProperties configurationProperties;
     ...
     */
    @Autowired
    public DozerAutoConfiguration(com.hengyunsoft.platform.config.dozer.DozerConfigurationProperties configurationProperties) {
