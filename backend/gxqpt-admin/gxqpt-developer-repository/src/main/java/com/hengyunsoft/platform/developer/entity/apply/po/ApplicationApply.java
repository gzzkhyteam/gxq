...
public class ApplicationApply extends BaseEntity<Long> implements Serializable {
    /**
     * ID
     *
     * @mbggenerated
     ...
     * @mbggenerated
     */
    @FieldDesc("应用/服务分类（共性应用、统一平台、共性服务等等）")
    @Length(max=100)
    private String type;
     ...
     * @mbggenerated
     */
    public Long getSuccessPassAppId() {
        return successPassAppId;
    }
     ...
     * @mbggenerated
     */
    public void setSuccessPassAppId(Long successPassAppId) {
        this.successPassAppId = successPassAppId;
    }
