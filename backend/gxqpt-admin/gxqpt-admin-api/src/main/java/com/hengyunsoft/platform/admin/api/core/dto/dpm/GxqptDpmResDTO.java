...
@Data
@ApiModel(value = "GxqptDpmRes", description = "查询返回实体")
public class GxqptDpmResDTO extends TreeNode<GxqptDpmResDTO,String> implements Serializable {
    /**
     * 上级部门
     *
     * @mbggenerated
     ...
     * @mbggenerated
     */
    @ApiModelProperty(value = "部门标示:2")
    private String treeType = "2";
     ...
     * @mbggenerated
     */
    @ApiModelProperty(value = "体系编码code")
     ...
     * @mbggenerated
     */
    @ApiModelProperty(value = "部门下人员集合")
