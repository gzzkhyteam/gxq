...
public class FileRecycle extends CommonBaseEntity<Long> implements Serializable {
    private Long id;
     ...
     * @mbggenerated
     */
    public Boolean getIsOneLevelDelete() {
        return isOneLevelDelete;
    }
     ...
     * @mbggenerated
     */
    public void setIsOneLevelDelete(Boolean isOneLevelDelete) {
        this.isOneLevelDelete = isOneLevelDelete;
    }
}