package com.hengyunsoft.platform.file.config.redis;
...
public class RedisConfiguration {
    ...
    public RedisTemplate<String, List<Map<String, Object>>> redisListTemplate(RedisConnectionFactory redisConnectionFactory) {
