...
@Data
@ApiModel(value = "LogStructAppOpen", description = "对外开放的结构化应用系统日志")
public class LogStructAppOpenDTO {
    /**
     * 文件服务器返回的文件id
     *
     * @mbggenerated
     *//*
    @ApiModelProperty(value = "实时写入的用WRITE 可选值：WRITE")
     ...
     *记录日志时间
     */
    @ApiModelProperty(value = "记录日志时间 yyyy-MM-dd HH:mm:ss")
     ...
     * @mbggenerated
     */
    @ApiModelProperty(value = "日志业务类型 LOGIN:登录 LOGOUT:登出 汉字说明：再有其他用汉字说明")
     ...
     * @mbggenerated
     *//*
    @ApiModelProperty(value = "采集渠道 WRITE")
