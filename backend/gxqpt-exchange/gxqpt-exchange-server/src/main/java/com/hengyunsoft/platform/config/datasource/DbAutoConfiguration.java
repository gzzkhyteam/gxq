...
public class DbAutoConfiguration extends BaseDbConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource_exchange") DataSource rdsDataSource) throws Exception {
        log.info("----------------SqlSessionFactory");
        return DataSourceFactory.createSqlSessionFactoryBean(rdsDataSource, new String[]{"classpath:mapper_exchange/**/*.xml"})
                .getObject();
    }
