package com.hengyunsoft.platform.exchange.utils.pinyin;
...
public class Pinyin4jUtil {
	...
	public static String getAllPingying(String str){
		if(str == null){
			return "";
		}
		StringBuffer pinyinName = new StringBuffer();
...
//		String cnStr = "重庆";
//		System.out.println("getPinYinHeadChar=" + getAllPingying(cnStr));
...
//	}
	...
	public static void main(String[] args){
		System.out.println("getSimplePinyin=" + getSimplePinyinHeadChar("人大工作"));
	}
}
