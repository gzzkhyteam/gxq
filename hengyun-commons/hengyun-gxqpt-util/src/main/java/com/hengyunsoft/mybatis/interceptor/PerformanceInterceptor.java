...
public class PerformanceInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        originalSql = originalSql.replaceAll("[\\s]+", SqlFormatter.SPACE);
        ...
        StringBuilder formatSql = new StringBuilder()
                ...
                .append(SqlFormatter.NEWLINE).append("Execute SQL：")
                .append(sqlFormat(originalSql, format)).append(SqlFormatter.NEWLINE);
...
//            BizAssert.assertFalse(" The SQL execution time is too large, please optimize ! ", this.getMaxTime() >= 1 && timing > this.getMaxTime());
            BizAssert.assertFalse(null, this.getMaxTime() >= 1 && timing > this.getMaxTime());
        }
        return result;
    }
