package com.hengyunsoft.commons.filter;
...
import com.hengyunsoft.commons.wrapper.XssRequestWrapper;
...
public class XssFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        log.info("ignorePaths={}, ignoreParamValues={}", ignorePaths, ignoreParamValues);
