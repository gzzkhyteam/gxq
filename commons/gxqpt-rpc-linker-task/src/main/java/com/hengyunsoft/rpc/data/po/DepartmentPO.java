...
public class DepartmentPO implements Serializable {
	...
	public String toString() {
		return "DepartmentPO [id=" + id + ", parentName=" + parentName + ", parentId=" + parentId + ", orgId=" + orgId
				+ ", name=" + name + ", shortName=" + shortName + ", elseName=" + elseName + ", forType=" + forType
				+ ", forClass=" + forClass + ", forindustry=" + forindustry + ", orgadmin=" + orgadmin + ", zipcode="
				+ zipcode + ", telcode=" + telcode + ", faxcode=" + faxcode + ", status=" + status + ", sortvalue="
				+ sortvalue + ", fornodetype=" + fornodetype + ", orgduty=" + orgduty + ", isdelete=" + isdelete
				+ ", isenable=" + isenable + "]";
	}
}