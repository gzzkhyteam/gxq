...
@Component("initialRemoteLoginFlowSetupAction")
public final class InitialRemoteLoginFlowSetupAction extends AbstractAction {
    ...
    protected Event doExecute(final RequestContext context) throws Exception {
        ...
        if(StringUtils.isNotBlank(loginUrl)) {
        	...
        	logger.warn("loginUrl must not be null.",
                    WebUtils.getHttpServletRequest(context).getRequestURL());
            throw new NoSuchFlowExecutionException(context.getFlowExecutionContext().getKey(),
                    new UnauthorizedServiceException("screen.service.required.message", "LoginUrl is required"));
        }
