...
import com.hengyunsoft.sso.webflow.RemoteAuthenticationViaFormAction;
 ...
 * @since 3.0.0
 */
@Component("remoteSendTicketGrantingTicketAction")
public final class RemoteSendTicketGrantingTicketAction extends AbstractAction {
    private static final Logger LOGGER = LoggerFactory.getLogger(RemoteSendTicketGrantingTicketAction.class);
     ...
     */
    public RemoteSendTicketGrantingTicketAction() {
        super();
    }
    ...
    private boolean isAuthenticatingAtPublicWorkstation(final RequestContext ctx) {
        if (ctx.getFlowScope().contains(RemoteAuthenticationViaFormAction.PUBLIC_WORKSTATION_ATTRIBUTE)) {
