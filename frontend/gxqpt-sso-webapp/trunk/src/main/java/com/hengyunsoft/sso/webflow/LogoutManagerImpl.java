...
public final class LogoutManagerImpl implements LogoutManager {
    ...
    protected LogoutManagerImpl() {
    	...
    	System.out.println("LogoutManagerImpl create");
    }
    ...
    private final static String LOGOUT_NOTIFY_URL = "logoutNotify";
    ...
    private URL determineLogoutUrl(final RegisteredService registeredService, final SingleLogoutService singleLogoutService) {
        try {
        	...
        	URIBuilder builder = new URIBuilder(singleLogoutService.getOriginalUrl());
        	System.out.println(builder.getHost());
        	String logoutUrlStr = singleLogoutService.getOriginalUrl();
        	List<NameValuePair> nameValuePairs = builder.getQueryParams();
        	for (NameValuePair nameValuePair : nameValuePairs) {
				if(LOGOUT_NOTIFY_URL.equals(nameValuePair.getName())){
					
					logoutUrlStr = nameValuePair.getValue();
					break ;
				}
			}
            ...
            String query = logoutUrl.getQuery();
