...
function dataPlatform_gxt_fun(shipData) {
    ...
    var app = {};
    option = null;
    var dwIcon = "../../static/v2/images/share/icon_002.png";
    var mlIcon = "../../static/v2/images/share/icon_001.png";
    var sjjIcon = "../../static/v2/images/share/icon_005.png";
    var apiIcon = "../../static/v2/images/share/icon_006.png";
    var maxLen = 9;
    var xs = 1; //横坐标节点的距离
    var gs = 2; //横坐标组的距离
    var lines = [];
