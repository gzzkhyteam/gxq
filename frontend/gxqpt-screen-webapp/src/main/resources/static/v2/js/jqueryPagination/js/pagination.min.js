        ...
        pagination: function (b, j, c,t) {
            ...
            if (b === "getPage") {
                ...
                if (b === "setPage") {
                    ...
                    g.get(0).pageText.totalSize = t;
                } else {
                    if (g.get(0).pageText == null) {
                        var m = [{value: 5, text: "5条/页"}, {value: 10, text: "10条/页"}, {
                            value: 15,
                            text: "15条/页"
                        }, {value: 20, text: "20条/页"}];
                        ...
                        g.get(0).pageText = {
                            ...
                            pageSize: (b.isShowPageSizeOpt == false ? false : true) ? p : b.pageSize
                        }
                    }
                }
            }
            ...
            if (g.get(0).pageText.isShowFL) {
                q += '<div class="whj_border whj_padding whj_bgc whj_pre ' + h + '" name="whj_firstPage">' + g.get(0).pageText.firstPage + "</div>"
            }
            q += '<div class="whj_border whj_padding whj_bgc whj_pre ' + h + '" name="whj_previousPage">' + g.get(0).pageText.previousPage + "</div>";
            if (g.get(0).pageText.showPageNum > 0) {
                for (var l = f; l <= g.get(0).pageText.totalPage; l++) {
                    ...
                    q += '<div class="whj_border whj_padding whj_bgc whj_pre ' + s + '" name="whj_page" data-page="' + l + '">' + l + "</div>";
                    if (o >= g.get(0).pageText.showPageNum) {
                        break
                    }
                }
            }
            q += '<div class="whj_border whj_padding whj_bgc whj_pre ' + e + '" name="whj_nextPage">' + g.get(0).pageText.nextPage + "</div>";
            if (g.get(0).pageText.isShowFL) {
                q += '<div class="whj_border whj_padding whj_bgc whj_pre ' + e + '" name="whj_lastPage">' + g.get(0).pageText.lastPage + "</div>"
            }
            ...
            if (g.get(0).pageText.isShowSkip) {
                q += '<div class="whj_padding whj_color">' + g.get(0).pageText.skip + '</div><input type="text" class="whj_border whj_color" name="whj_toPage" onchange="$(this).next().click();"/><div class="whj_border whj_padding whj_bgc whj_hover" name="whj_confirm">' + g.get(0).pageText.confirm + "</div>"
            }
