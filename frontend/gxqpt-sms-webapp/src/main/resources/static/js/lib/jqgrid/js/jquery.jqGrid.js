		...
		populate = function (npage) {
			if(!ts.grid.hDiv.loading) {
				...
				case "script":
                    ...
                    //var token="eyJhbGciOiJSUzI1NiJ9.eyJzdWIiOiIzNWtqNjM1MyIsImFwcE5hbWUiOiLmtojmga_nrqHnkIbns7vnu58iLCJleHAiOjE1MjQ5OTI4MDd9.ivhqNvVt6Tb0ormacxGKvTchmIIen0j3pCeVQ6lwklGXnIBNzLVV7QHYYm-TtarRbJXq0Tetn4neDFAf7xDkp5tDGDX0FcYnNcGVw4tt7lXp_xmYKib2frY0w5tQbhj3bP05bgriYP1nwf8rxrTjhUjBc5NMPmbVQavTMKHFKEY" ;
                    ...
                    if(ts.p.contentType){
                        ajaxOpt["contentType"] = ts.p.contentType;
                    }
                    $.ajax($.extend(ajaxOpt,$.jgrid.ajaxOptions, ts.p.ajaxGridOptions));
				break;
				case "xmlstring":
					beginReq();
