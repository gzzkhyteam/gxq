...
(function (a) {
    $.fn.extend({
        pagination: function (b, j, c,t) {
                ...
                if (b === "setPage") {
                    ...
                    if (g.get(0).pageText == null) {
                        ...
                        g.get(0).pageText = {
                            ...
                            totalDataText: b.totalDataText != null ? b.totalDataText : "共{}条",
                            ...
                            isShowTotalData: !!b.isShowTotalData,
            ...
            if (g.get(0).pageText.isShowTotalData) {
                var n = g.get(0).pageText.totalDataText.replace("{}", g.get(0).pageText.totalSize);
