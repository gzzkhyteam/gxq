...
import com.hengyunsoft.platform.interceptor.LoginCheckInterceptorExt;
...
public class WebConfiguration extends WebMvcConfigurerAdapter {
    ...
    @Bean
    LoginCheckInterceptorExt getLoginCheckInterceptor() {
        return new LoginCheckInterceptorExt();
    }
