var fileUploadAddress="http://127.0.0.1:9526/gydbdc-upload-webapp";
	...
	(function( $ ){
	    ...
	    $(function() {
	        ...
	        uploader = WebUploader.create({
	            ...
	            chunked: false,
	            chunkSize: 512 * 1024,
	            server:fileUploadAddress+'/file/uploader.do',
	            // runtimeOrder: 'flash',
	        ...
	        function addFile( file ) {
	            ...
	            var $li = $( '<li id="' + file.id + '" >' +
	                    '<p class="title" style="text-align:center; text-indent:0;">' + fileName + '</p>' +
	                    '<p class="imgWrap"></p>'+
