...
(function (factory) {
  ...
  Viewer.prototype = {
    ...
    build: function () {
      ...
      $('#main-container',window.parent.document).append($viewer);
      //$this.after($viewer);
    ...
    initImage: function (callback) {
      ...
      var footerHeight = this.$footer.height();
        var viewerWidth = $('#main-container',window.parent.document).width();
        var viewerHeight = max($('#main-container',window.parent.document).height()+$('#main-container-body',window.parent.document).height() - footerHeight, footerHeight);
