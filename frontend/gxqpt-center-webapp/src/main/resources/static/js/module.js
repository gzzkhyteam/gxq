...
function pagerList(pagerInfo){
    ...
    if(pagerInfo.isFirstPage){
        html+='<li><i class="fa fa-step-backward iDisabled" title="首页" pageNum="'+pagerInfo.firstPage+'"></i></li>';
        html+='<li><i class="fa fa-backward iDisabled" title="上一页" pageNum="'+pagerInfo.prePage+'"></i></li>';
	}else{
        html+='<li><i class="fa fa-step-backward" title="首页" pageNum="'+pagerInfo.firstPage+'" onclick="pager(this)"></i></li>';
    ...
    if(pagerInfo.isLastPage){
        ...
        html+='<li><i class="fa fa-step-forward iDisabled" title="尾页" pageNum="'+pagerInfo.lastPage+'"></i></li>';
    }else{
        html+='<li><i class="fa fa-forward" title="下一页" pageNum="'+pagerInfo.nextPage+'" onclick="pager(this)"></i></li>';
        html+='<li><i class="fa fa-step-forward" title="尾页" pageNum="'+pagerInfo.lastPage+'" onclick="pager(this)"></i></li>';
    }
    html+='<li>显示&nbsp;';
