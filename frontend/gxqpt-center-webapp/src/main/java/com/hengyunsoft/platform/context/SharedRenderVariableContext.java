...
public class SharedRenderVariableContext implements ServletContextAware {
    ...
    @Autowired
    private GxqptWebappConfig gxqptCenterWebappConfig;
...
//        servletContext.setAttribute("_logout_url", globalVariableProperties.getLogoutUrl());
        servletContext.setAttribute("_app_id", gxqptCenterWebappConfig.getAppId());
